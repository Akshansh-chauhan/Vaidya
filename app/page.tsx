  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-full hover:bg-white/30 transition-colors text-sm font-medium text-white/80 hover:text-white cursor-pointer"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-44 bg-white/80 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-white/60 z-[100] overflow-hidden p-1.5">
          <div
            ref={listRef}
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const hasPassedHero = currentScrollY > window.innerHeight * 0.72

      setUseDarkNavText(hasPassedHero)
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative min-h-[100vh] overflow-hidden">
        ...
        <div className="fixed top-5 left-0 right-0 z-50 px-4 pointer-events-none">
          <div className="relative mx-auto max-w-6xl">
            ...
            >
              ...
              <span
                className={`text-[17px] font-bold tracking-tight transition-colors duration-300 ${useDarkNavText ? "text-zinc-900" : "text-white"
                  }`}
            ...
            <div className="flex justify-center">
              ...
              >
                <div className="hidden md:flex items-center">
                  <Link href="/scan" className="text-zinc-600 hover:text-zinc-900 transition-colors px-3 py-1.5 rounded-full hover:bg-white/50 text-[14px] font-medium">
                    {t.nav.healthScan}
                  </Link>
                  <Link href="/reports" className="text-zinc-600 hover:text-zinc-900 transition-colors px-3 py-1.5 rounded-full hover:bg-white/50 text-[14px] font-medium">
                    {t.nav.reports}
                  </Link>
                  <Link href="/plans" className="text-zinc-600 hover:text-zinc-900 transition-colors px-3 py-1.5 rounded-full hover:bg-white/50 text-[14px] font-medium">
                    {t.nav.plans}
                  </Link>
                </div>

                <div className="flex items-center gap-1 md:pl-1">
                  <div className={useDarkNavText ? "nav-text-dark" : undefined}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[100vh] px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="anim-fade-up text-5xl sm:text-6xl lg:text-[80px] font-semibold tracking-[-0.04em] text-white leading-[1.05] mb-6 drop-shadow-[0_2px_20px_rgba(0,0,0,0.3)]" style={{ fontFamily: 'var(--font-outfit)' }}>
              {t.hero.title}{" "}
              <span className="text-white/80">{t.hero.highlight}</span>
            </h1>

            <p className="anim-fade-up anim-delay-1 text-lg sm:text-xl text-white/75 text-balance max-w-2xl mx-auto mb-10 leading-relaxed">
              {t.hero.subtitle}
            </p>

            <div className="anim-fade-up anim-delay-2 flex flex-col sm:flex-row gap-3 justify-center mb-16">
            ...
            <div className="anim-fade-up anim-delay-3 relative max-w-3xl mx-auto h-[260px] sm:h-[300px]">
              {/* Center — Recovery Score */}
              <div className="glass-card-dark absolute left-1/2 -translate-x-1/2 top-0 w-[220px] sm:w-[260px] p-5 sm:p-6 z-30 anim-float">
                ...
                <div className="flex items-end gap-2 mb-2">
                  <span className="text-4xl sm:text-5xl font-bold text-white" style={{ fontFamily: 'var(--font-outfit)' }}>87</span>
              ...
              {/* Left — HRV */}
              <div className="glass-card-dark absolute left-2 sm:left-4 top-16 sm:top-12 w-[170px] sm:w-[200px] p-4 sm:p-5 z-20 anim-float-reverse opacity-90">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-white" style={{ fontFamily: 'var(--font-outfit)' }}>65.1 <span className="text-sm font-medium text-white/40">ms</span></p>
              ...
              {/* Right — Resting HR */}
              <div className="glass-card-dark absolute right-2 sm:right-4 top-20 sm:top-16 w-[170px] sm:w-[200px] p-4 sm:p-5 z-20 anim-float opacity-85">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-white" style={{ fontFamily: 'var(--font-outfit)' }}>52 <span className="text-sm font-medium text-white/40">bpm</span></p>
          ...
          {/* Trust badges */}
          <div className="anim-fade-up anim-delay-4 flex flex-wrap justify-center gap-3 mt-4 sm:-mt-4 relative z-20">
            {[t.benefits.b1, t.benefits.b2, t.benefits.b3].map((b, i) => (
              <div key={i} className="glass-card-dark flex items-center gap-2 px-4 py-2.5 !rounded-full text-[14px] text-white/80 font-medium !shadow-sm">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="lg:col-span-2 anim-fade-up anim-delay-1">
              <div className="glass-card p-8 sm:p-10 relative overflow-hidden min-h-[340px] flex flex-col justify-end group">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/80 via-transparent to-violet-50/60 rounded-[24px]" />
                <div className="perspective-card absolute right-4 sm:right-8 top-6 sm:top-8 w-[50%] max-w-[240px]">
                ...
                <div className="relative z-10 max-w-sm">
                  <div className="w-11 h-11 bg-blue-100 rounded-2xl flex items-center justify-center mb-5">
                    <Activity className="w-5 h-5 text-blue-600" />
                  </div>
                  <h3 className="text-2xl font-semibold text-zinc-900 mb-2 tracking-tight" style={{ fontFamily: 'var(--font-outfit)' }}>{t.features.posture}</h3>
                  <p className="text-zinc-500 leading-relaxed">{t.features.postureDesc}</p>
                </div>
              </div>
            </div>
