    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
        <div className="text-center mb-6 anim-fade-up">
          <div className="inline-flex items-center gap-2 glass-card !rounded-full px-4 py-2 !shadow-sm text-sm font-medium text-rose-500 mb-4">
            <Scan className="w-4 h-4" />
            AI-Powered Analysis
          </div>
          <h1 className="text-3xl sm:text-4xl font-semibold text-zinc-900 tracking-tight mb-2" style={{ fontFamily: 'var(--font-outfit)' }}>{t.scanPages.skin.title}</h1>
          <p className="text-zinc-500 max-w-2xl mx-auto">{t.scanPages.skin.desc}</p>
        </div>
        <HealthChatbot scanType="skin" title={t.scanPages.skin.title} description={t.scanPages.skin.chatDesc} acceptedFiles="image/*" />
      </div>
    </div>
  )
}
